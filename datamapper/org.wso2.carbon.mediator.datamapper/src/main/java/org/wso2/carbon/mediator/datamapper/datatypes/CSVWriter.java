...
public class CSVWriter implements OutputWriter {
	...
	private final static String ROOT_TAG = "<text xmlns=\"http://ws.apache.org/commons/ns/payload\"></text>";
	private final static Log log = LogFactory.getLog(CSVWriter.class);
	...
	public String getOutputMessage(String outputType, GenericRecord result)
		...
		try {
			...
			handleException("Data coversion Failed at CSVWriter..", e);
		} finally {
			encoder.flush();
		}
